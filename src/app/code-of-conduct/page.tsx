...
export default function Page() {
  return (
    <>
      <Container>
        <h1 className="my-10 text-2xl lg:text-4xl">TSKaigi Kansai行動規範</h1>
        <div className="text-lg">
          TSKaigi
          Kansaiに参加するすべての人は下記の行動規範を守ることを求められます。主催者はこの行動規範をカンファレンス、パーティ、交流会に適用します。すべての人にとって安全な場所を提供するため、聴講者、登壇者、スポンサー、主催スタッフ含めたすべての参加者にご協力をお願いします。
          <br />
          <br />
