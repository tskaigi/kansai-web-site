import type { Committee } from "../lib/data/committee";

export default function CommitteeCards({
  cardData,
}: { cardData: Committee[] }) {
  return (
    <ul className="mx-auto mt-20 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-8">
      {cardData.map((data) => (
        <li
          key={data.title}
